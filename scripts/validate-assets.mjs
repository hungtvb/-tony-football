...
for (const [sourceName, source, contracts] of [
  ...
  ["BrowserModelViewAdapter.js", adapterSource, ["createSnapshotRenderState", "createDefaultPlayerAssetLoader", "disposePlayerAssetTemplate", "appearanceDiagnostics(playerViews)", "integratedBodySurfaceCount", "bootRegionCount", "hairlessPlayers", "bootlessPlayers", "preservedMapPlayers"]],
  ["RigFootballKitOverlay.js", rigAppearanceSource, ["TonyRigIntegratedAppearanceMaterial", "vTonyBodyPosition", "tonyAppearanceRegion", "tonyIntegratedAppearance", "tonyBodyConforming", "integrated-body-material", "TonyRigHair", "tonyRigHairGeometry", "tonySourceMapPreserved", "bootRegionCount", "rigidPrimitiveCount"]],
...
for (const rigidPrimitive of ["new THREE.SkinnedMesh", "new THREE.BoxGeometry", "new THREE.CylinderGeometry", "bone.add(mesh)"]) if (rigAppearanceSource.includes(rigidPrimitive)) throw new Error(`RigFootballKitOverlay.js: rigid bone-attached appearance primitive remains: ${rigidPrimitive}`);
