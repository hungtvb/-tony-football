...
for (const [sourceName, source, contracts] of [
  ...
  ["RigFootballKitOverlay.js", rigAppearanceSource, ["new THREE.SkinnedMesh", "THREE.DetachedBindMode", "vTonyBodyPosition", "tonyBodyConforming", "TonyRigKitSurface", "TonyRigBootSurfaceLeft", "TonyRigBootSurfaceRight", "TonyRigHair", "tonySourceMapPreserved", "rigidPrimitiveCount"]],
