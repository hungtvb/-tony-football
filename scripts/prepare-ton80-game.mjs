...
const PREPARED_MARKERS = Object.freeze([
  ...
  "window.__TONY_SETTINGS_EFFECTS_BRIDGE__",
]);
...
export function prepareTon80Game({ cwd = process.cwd(), run = spawnSync } = {}) {
  ...
  try {
    ...
    runStep(run, "python3", [resolve(cwd, "scripts/ton-84-migrate-settings-effects.py")], workdir);
    ...
    console.log(previous === generated ? "TON-84 generated artifact unchanged" : "TON-84 generated artifact prepared");
