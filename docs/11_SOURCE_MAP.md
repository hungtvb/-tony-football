...
| `src/game/engine/` | R1 command, event, snapshot, state factory, headless MatchEngine lifecycle, player movement, and ball simulation | Headless only; no DOM, Three.js, Canvas, audio, or render-frame dependencies |
