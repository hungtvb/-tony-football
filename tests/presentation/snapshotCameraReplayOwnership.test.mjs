...
test("generated runtime consumes camera and replay facts without projecting them", () => {
...
test("browser entry registers one exact-once camera replay owner before projected consumers", () => {
  ...
  assert.match(entry, /generated\/game\.js\?v=25\.0\.0/);
  assert.ok(entry.indexOf("() => cameraReplayAdapter") < entry.indexOf('"webgl-model"'));
