...
test("replay snapshots retain ball velocity and trail", () => {
  ...
  assert.match(source, /const renderTrail=replayFrame\?\.ball\.trail\|\|snapshot\.ball\.trail/);
  assert.doesNotMatch(source, /const renderTrail=replayFrame\?\.ball\.trail\|\|ball\.trail/);
